    ...
    <div>
        <div v-show="$route.meta.navShow">
          ...
          <div class="search-wrap" ref="searchWrap">
            <ul class="nav-side">
              <li v-for="(item,index) in categoryData" v-text="item.name" :class="{'active' : currentIndex === index}" @click="selectMenu(index)"></li>
            </ul>
            <div class="search-content">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide" v-for="item in categoryData" v-text="item.desc"></div>
                </div>
              </div>
            </div>
          </div>
